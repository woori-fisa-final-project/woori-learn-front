...
} from "../(education)/scenario/components/practice/automaticpayment/Scenario11";
import Scenario12 from "../(education)/scenario/components/practice/automaticpayment/Scenario12";
import Scenario18, { type Scenario18Detail } from "../(education)/scenario/components/practice/automaticpayment/Scenario18";
import Scenario19 from "../(education)/scenario/components/practice/automaticpayment/Scenario19";
