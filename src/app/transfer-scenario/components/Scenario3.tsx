...
import { BANK_IMAGES } from "@/utils/bankUtils";
...
export default function Scenario3({
  ...
  const displayBank = selectedBank ?? allowedBankName;
  const bankImage = BANK_IMAGES[displayBank] || "/images/bank3.png";
  const [isBankErrorModalOpen, setBankErrorModalOpen] = useState(false);
